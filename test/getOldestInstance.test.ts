...
describe("findOldestInstance", () => {
    it("should identify the oldest instance correctly", () => {
        ...
        const oldestInstance = new Instance("id123", referenceDate, "ip1", "testAutoScalingGroup");
        const newerInstance = new Instance("id124", createDate(referenceDate, 7), "ip2", "testAutoScalingGroup");
        const newestInstance = new Instance("id125", createDate(referenceDate, 21), "ip3", "testAutoScalingGroup");
